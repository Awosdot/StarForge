...
fn test_generate_rust_bindings() {
    ...
    if result.is_ok() {
        ...
        assert!(generated.contains("pub struct ContractClient"), "Missing ContractClient struct");
        assert!(generated.contains("impl ContractClient"), "Missing ContractClient implementation");
    }
...
fn test_generate_typescript_bindings() {
    ...
    if result.is_ok() {
        let generated = result.unwrap();
        assert!(generated.contains("export class ContractClient"), "Missing ContractClient class");
...
fn test_generate_python_bindings() {
    ...
    if result.is_ok() {
        let generated = result.unwrap();
        assert!(generated.contains("class ContractClient"), "Missing ContractClient class");
        assert!(generated.contains("@dataclass"), "Missing dataclass decorators");
    }
}
...
fn test_generate_go_bindings() {
    ...
    if result.is_ok() {
        let generated = result.unwrap();
        assert!(generated.contains("type ContractClient struct"), "Missing ContractClient struct");
        assert!(generated.contains("func NewContractClient"), "Missing constructor");
    }
}
